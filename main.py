...
def results():
    ...
    return render_template('index.html', temp=temp, resp=resp, city=city, error=error, country=country, weather=weather, icon_url=icon_url, humidity=humidity, feels_like=feels_like, pressure=pressure,
                           longitude=longitude, latitude=latitude, windSpeed=windSpeed)
